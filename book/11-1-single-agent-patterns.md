...
> 📍 **11장 전체 구성**
> - **[1부: 기본 패턴 - 단일 에이전트](11-1-single-agent-patterns.md)** ← 현재 위치
> - [2부: 확장 패턴 - 복합 조직 시스템](11-2-organizational-standards.md)
...
| **복합 조직**<br>(6개+, 다수 사용자) | **구조적**: SSOT, SoC<br>**실행**: 산출물 중심, 점진적 개선, 컨텍스트 명시성<br>**검증**: 투명성·추적성 | **구조적**: SSOT, SoC, MECE, 원자성<br>**실행**: 모두<br>**검증**: 투명성·추적성, Human-in-the-Loop | **구조적**: 모두<br>**실행**: 모두<br>**검증**: 모두 |
...
**11장 2부 (다음 파일)**: 단위 조직 및 복합 조직 시스템 (사례 4-6)
...
| **복합 조직**<br>(11장 2부) | 11.4 회의록 요약<br>(단일 템플릿) | 11.5 사내 Q&A 봇<br>(RAG: 검색+답변) | 11.6 고객 리뷰 분석<br>(분류+추출+요약) |
