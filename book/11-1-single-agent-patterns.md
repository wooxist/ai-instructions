...
| :--- | :--- | :--- | :--- |
| **단일 에이전트** | 11.1 이메일 요약 | 11.2 블로그 초고 작성 | 11.3 법률 조항 분석 |
| **다중 에이전트** | 11.4 콘텐츠 생성 파이프라인 | 11.5 코드 생성 및 리뷰 | 11.6 재무 데이터 분석 및 보고 |
| **조직 표준** | 11.7 회의록 요약 표준화 | 11.8 사내 Q&A 봇 | 11.9 고객 리뷰 분석 시스템 |
