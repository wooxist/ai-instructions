...
지금까지 살펴본 메타 원칙들은 좋은 인스트럭션을 설계하기 위한 '지도'와 같습니다. 이제 이 지도를 바탕으로, [5장. 역할(Agent)과 제약(Constraint) 설계](05-agent-constraints.md)에서는 인스트럭션을 수행할 주체인 AI의 역할을 정의하고, 그 역할이 지켜야 할 규칙을 설정하는 구체적인 방법을 알아봅니다.
