...
* [8장. 성능 최적화: 품질, 비용, 속도의 균형 맞추기](08-performance.md)
  ...
  * [8.4 실무 예제로 이어보기](08-performance.md#84-실무-예제로-이어보기)
...
* [10장. 고급 협업 아키텍처와 시스템 설계](10-advanced-collaboration-architectures.md)
  ...
  * [10.2.1 산출물의 이중적 역할](10-advanced-collaboration-architectures.md#1021-산출물의-이중적-역할)
  * [10.2.2 파일 기반 산출물 설계 가이드](10-advanced-collaboration-architectures.md#1022-파일-기반-산출물-설계-가이드)
  * [10.3 계층적 협업 아키텍처](10-advanced-collaboration-architectures.md#103-계층적-협업-아키텍처)
  * [10.4 실행 감독과 안정성 설계 (아키텍트의 역할)](10-advanced-collaboration-architectures.md#104-실행-감독과-안정성-설계-아키텍트의-역할)
  * [10.5 확장: 다중 작업(Job) 관리](10-advanced-collaboration-architectures.md#105-확장-다중-작업job-관리)
  * [10.5.1 디렉토리 구조: 설계와 실행의 분리](10-advanced-collaboration-architectures.md#1051-디렉토리-구조-설계와-실행의-분리)
  * [10.5.2 작업 상태 관리와 연속성 보장](10-advanced-collaboration-architectures.md#1052-작업-상태-관리와-연속성-보장)
  * [10.5.3 아키텍트의 확장된 역할](10-advanced-collaboration-architectures.md#1053-아키텍트의-확장된-역할)
* [11장 1부: 기본 패턴 - 단일 에이전트 설계](11-1-single-agent-patterns.md)
  * [11.1 [사례 1] 단일 에이전트, 간단/일상](11-1-single-agent-patterns.md#111-사례-1-단일-에이전트-간단일상)
  * [11.2 [사례 2] 단일 에이전트, 표준/전문](11-1-single-agent-patterns.md#112-사례-2-단일-에이전트-표준전문)
  * [11.3 [사례 3] 단일 에이전트, 복잡/중요](11-1-single-agent-patterns.md#113-사례-3-단일-에이전트-복잡중요)
* [11장 2부: 확장 패턴 - 조직 표준 시스템](11-2-organizational-standards.md)
  * [11.4 [사례 4] 조직 표준, 간단/일상](11-2-organizational-standards.md#114-사례-4-조직-표준-간단일상)
  * [11.5 [사례 5] 조직 표준, 표준/전문](11-2-organizational-standards.md#115-사례-5-조직-표준-표준전문)
  * [11.6 [사례 6] 조직 표준, 복잡/중요](11-2-organizational-standards.md#116-사례-6-조직-표준-복잡중요)
* [11장. 도구(Tools)와 플러그인 활용](12-tools.md)
...
* [12장. 도메인 특화 언어(DSL) 설계: AI와 소통하는 우리만의 언어](13-workflow-as-code.md)
  * [12.1 도메인 특화 언어(DSL)란 무엇인가?](13-workflow-as-code.md#121-도메인-특화-언어dsl란-무엇인가)
  * [12.2 왜 우리만의 언어(DSL)가 필요한가?](13-workflow-as-code.md#122-왜-우리만의-언어dsl가-필요한가)
* [13장. 살아있는 시스템: 인스트럭션의 진화와 관리](14-evolution.md)
  * [13.1 조직의 성장에 따른 진화](14-evolution.md#131-조직의-성장에-따른-진화)
  * [13.2 기술의 발전에 따른 진화](14-evolution.md#132-기술의-발전에-따른-진화)
  * [13.3 에이전트의 협력과 진화: 상호운용성의 미래](14-evolution.md#133-에이전트의-협력과-진화-상호운용성의-미래)
  * [13.4 인스트럭션의 '부패'와 유지보수 (Instruction Decay)](14-evolution.md#134-인스트럭션의-부패와-유지보수-instruction-decay)
  * [13.5 최종 요약: 좋은 인스트럭션의 가치는 변하지 않는다](14-evolution.md#135-최종-요약-좋은-인스트럭션의-가치는-변하지-않는다)
