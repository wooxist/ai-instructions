...
1부에서는 단일 에이전트가 개인의 생산성을 높이는 방법을 살펴보았습니다. 이제 2부에서는 여러 에이전트가 협력하여 팀의 복잡한 과업을 자동화하는 것을 넘어, 개인이나 팀의 인스트럭션을 **조직 전체의 표준 자산**으로 확장하는 패턴을 다룹니다.
...
---
[다음으로: 4부 - 고급 아키텍처와 실전 구현](11-3-advanced-architectures.md)
