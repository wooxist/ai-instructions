...
- **Part 2 (시스템 설계):** [4장](04-meta-principles.md)부터 [10장](10-1-single-agent-patterns.md)까지는 AI의 역할을 정의하고, 입출력을 설계하며, 여러 AI를 협력시키는 '인스트럭션 시스템'을 구축하는 구체적인 방법론과 패턴을 다룹니다.
