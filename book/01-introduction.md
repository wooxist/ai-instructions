...
- [9장. 생산성: 나만의 에이전트 구축하기](09-productivity.md): 나만의 에이전트를 만들고 관리하는 방법을 배웁니다.
- [10장. 상황별 인스트럭션 설계 패턴 예제](10-1-single-agent-patterns.md): 실제 사례를 통해 설계 원칙을 적용합니다.
- [11장. 도구(Tools)와 플러그인 활용](11-tools.md): 외부 도구를 연동하여 에이전트의 능력을 확장합니다.
- [12장. 워크플로우 자동화와 코드형 인프라](12-workflow-as-code.md): 전체 프로세스를 코드로 관리하고 자동화합니다.
