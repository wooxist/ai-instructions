...
- 자주하는 실수: ‘충분히 빠름’ 같은 모호한 기준, 정의되지 않은 용어
...
- 자주하는 실수: 범위를 넓게 두면 잡음이 늘어납니다. 대상·기간·자료원을 함께 적으세요.
...
- 자주하는 실수: 현실 제약이 없으면 실행 불가 아이디어가 늘어납니다. 제약을 꼭 함께 명시하세요.
...
- 자주하는 실수: 기준이 모호하거나 서로 다른 범주를 섞으면 비교가 흐려집니다.
...
- 자주하는 실수: 제약이 빠지면 책상머리 설계가 됩니다. 환경 정보를 맨 앞에 배치하세요.
...
- 자주하는 실수: 개선 없이 재진술만 하는 경우가 있습니다. 반드시 ‘개선 전/후 비교’를 요구하세요.
