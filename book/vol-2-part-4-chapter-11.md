...
- [ ] 사고 클러스터의 정의와 역할을 설명할 수 있다
- [ ] 인간(사고 조율자)과 AI(실행 워커)의 역할을 구분할 수 있다
- [ ] 사고와 실행 항목의 차이를 명확히 이해한다
- [ ] 목표를 사고 프로세스로 분해할 수 있다
- [ ] 기본 설계 패턴 3가지를 적용할 수 있다

### 실습 과제
1. 자신의 업무에서 전략적 목표 1개를 선택하세요
2. 그 목표를 사고 클러스터로 분해하세요 (3-5단계)
3. 각 단계의 핵심 질문을 정의하세요
4. 인간의 판단이 필요한 의사결정 지점을 표시하세요
5. YAML 형식으로 사고 클러스터를 작성하세요
