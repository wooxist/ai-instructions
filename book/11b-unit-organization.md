...
- **핵심 원칙:** `SoC`, `계층 구조`, [Human-in-the-Loop](glossary.md#human-in-the-loop)
...
- **[Human-in-the-Loop](glossary.md#human-in-the-loop):** 창의적인 방향성을 결정하는 중요한 단계를 인간이 직접 수행하여, 자동화의 효율성과 인간의 통찰력 사이의 균형을 맞춥니다.
...
- [ ] [Human-in-the-Loop](glossary.md#human-in-the-loop) 승인을 적절한 지점에 배치할 수 있다
