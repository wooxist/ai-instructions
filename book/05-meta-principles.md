...
### 이 장에서 배우는 것
- 설계 메타 원칙 4축(구조·과정·검증·거버넌스)과 적용 포인트
- 각 원칙의 좋은/나쁜 예와 짧은 체크리스트
- 다른 장과의 연결 지점: [3장](03-good-instructions.md)·[4장](04-context.md)·[6장](06-limits.md)·[7장](07-agent-persona.md)
...
### 5.1.1 SSOT (Single Source of Truth)[^1]
...
### 5.1.2 SoC (Separation of Concerns)[^2]
- 하나의 소제목은 하나의 결과/목표만 다룹니다(겹침 최소화).
- 좋은 예: 형식 지정은 [4장](04-context.md)에서, 성공 기준은 [3장](03-good-instructions.md)에서 각각 다루고 교차참조
- 나쁜 예: 한 소제목에 형식·컨텍스트·성공 기준을 모두 뒤섞어 기술
- 체크: 소제목별 “주제·목표·결과”가 1:1:1인지 확인

### 5.1.3 MECE (Mutually Exclusive, Collectively Exhaustive)[^3]
...
### 5.1.4 Convention over Configuration[^4]
...
### 5.2.1 점진적 개선(Iterative Refinement)[^6]
...
### 5.2.2 자기 계획·검토(Auto-Planning & Review)[^7]
...
### 5.2.5 의도 확인 루프(Intent Clarification Loop)[^10]
- 목표·범위·우선순위가 명확해질 때까지 짧게 질의응답합니다.
- 좋은 예: “목표/대상/제약/형식” 4문으로 확인 후 본 작업 착수([4장](04-context.md) 참조)
...
### 5.3.3 투명성·추적 가능성(Transparency & Traceability)[^11]
...
### 5.4.1 윤리 경계(Ethical Boundaries)
