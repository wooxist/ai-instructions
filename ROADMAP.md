...
- [x] 10장 1부: 단일 에이전트 패턴 (v1-released)
- [x] 10장 2부: 다중 에이전트 워크플로우 (v1-released)
- [x] 10장 3부: 조직 표준 시스템 (v1-released)
- [x] 10장 4부: 고급 아키텍처 (v1-released)
- [x] 11장: 도구(Tools)와 플러그인 활용 (v1-released)
- [ ] 12장: 워크플로우 자동화와 코드형 인프라 (v1-draft)
- [x] 13장: 살아있는 시스템: 인스트럭션의 진화와 관리 (v1-released)
