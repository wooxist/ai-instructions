...
- [ ] 6가지 질문 유형의 정의와 활용 시점을 구분할 수 있다
- [ ] 동일 과제를 질문 유형별로 재구성해 장단점을 비교할 수 있다
- [ ] 판단 기준(개수, 기간, 형식, 대상 등)을 명시해 재작업을 줄일 수 있다

### 실습 과제
1. 현재 진행 중인 업무를 하나 고르고, 폐쇄형/개방형/탐색형 중 가장 적합한 유형으로 질문을 설계하세요.
2. 동일 과제를 비교형 질문으로도 설계하고, 선택 기준 3개를 명시해 답변을 비교하세요.
...
**개념 이해:**
- [ ] 6가지 질문 유형(폐쇄형, 개방형, 탐색형, 비교형, 맥락 의존형, 메타)의 차이를 설명할 수 있다
