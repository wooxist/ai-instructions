...
## 📖 다음 장 미리보기: 3장. 좋은 인스트럭션

좋은 질문 설계를 배웠다면, 이제 일회성 질문을 넘어 '재사용 가능한 지시 체계'로 진화할 차례입니다.

**3장에서는 다음을 배웁니다:**
- 좋은 인스트럭션의 5가지 핵심 원칙 (명확성, 구체성, 단계성, 제약, 안티패턴)
- 8가지 핵심 구성 요소 (목적, 역할, 입력, 처리방법, 출력, 제약조건, 평가기준, 기초지식)
- 표준 인스트럭션 템플릿과 실전 예시

인스트럭션은 숲련된 요리사가 비법을 '레시피'로 만드는 것과 같습니다. 누구든 같은 맛을 재현할 수 있도록 표준화하는 것이죠.

**이 장이 중요한 이유:**
- 일관되고 예측 가능한 결과물을 만들 수 있습니다
- 개인의 생산성을 넘어 팀 전체의 자산으로 발전합니다
- 처음 부터 제대로 만들면 재작업이 크게 줄어듭니다

💡 **시작하기 전 준비**: 자신이 반복적으로 하는 작업 1개를 떠올려보세요. (예: 보고서 작성, 코드 리뷰, 고객 응대) 3장의 8가지 구성 요소 템플릿을 사용하여 이 작업을 인스트럭션으로 만들어볼 겁니다.
