...
## 4.6 시스템 설계 원칙 관계도 (요약)

아래 관계도는 시스템 설계 원칙들이 서로 어떻게 연결되어 실제 설계·운영 전반에 영향을 주는지 한눈에 보여줍니다.
...
graph LR
  GI["3장: 효과적인 지시<br/>4가지 기본 원칙"]:::principle
...
이 장에서 배운 개념들을 종합하여 실제 파일 기반 인스트럭션 시스템으로 구축하는 전체 과정은 11장. 상황별 설계 패턴 예제 (2권)에서 자세히 다룹니다.
