...
3장에서 다룬 '효과적인 지시의 4가지 기본 원칙(명확성, 구체성, 단계성, 제약 설정)'은 개별 프롬프트와 인스트럭션 작성의 기초가 되는 실용적인 지침입니다. 4장에서 살펴본 AI의 한계(Context Window, 할루시네이션 등)는 이러한 체계적인 접근의 필요성을 더욱 강조합니다. 즉, 3장의 기본 원칙들이 '전술'이라면, 5장의 시스템 설계 원칙들은 4장의 문제들을 해결하기 위한 '전략'입니다.
...
다음 시나리오에 적용해야 할 시스템 설계 원칙을 시스템 설계 원칙 요약표(5.4절)를 참고하여 선택하고, 그 이유를 설명하세요:
...
5.5절의 "원칙 선택 체크리스트"를 사용하여 자신의 프로젝트를 분석하세요:
