...
### 5.1.1 제약 1: Context Window 한계와 Lost in the Middle
...
### 5.1.2 제약 2: 할루시네이션 (Hallucination)
...
### 5.1.4 제약 4: 유지보수 어려움 (Maintenance Difficulty)
